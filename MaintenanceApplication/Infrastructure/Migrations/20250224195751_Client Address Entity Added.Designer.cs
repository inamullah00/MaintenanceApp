...
namespace Maintenance.Infrastructure.Migrations
{
    ...
    [Migration("20250224195751_Client Address Entity Added")]
    partial class ClientAddressEntityAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Maintenance.Domain.Entity.ClientEntities.ClientAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Maintenance.Domain.Entity.SettingEntities.ContactUs", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MarkedAsReadByUser")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("MarkedAsReadByUser");

                    b.ToTable("ContactUs");
                });

            modelBuilder.Entity("Maintenance.Domain.Entity.SettingEntities.Setting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Maintenance.Domain.Entity.ClientEntities.OfferedService", b =>
                {
                    ...
                    b.HasOne("Maintenance.Domain.Entity.ClientEntities.ClientAddress", "ClientAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Maintenance.Domain.Entity.SettingEntities.ContactUs", b =>
                {
                    ...
                    b.HasOne("Domain.Entity.UserEntities.ApplicationUser", "MarkAsReadBy")
                        .WithMany()
                        .HasForeignKey("MarkedAsReadByUser")
                        .OnDelete(DeleteBehavior.NoAction);
